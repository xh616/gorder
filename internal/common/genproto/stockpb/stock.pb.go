...
import (
	orderpb "github.com/xh/gorder/internal/common/genproto/orderpb"
...
const file_stockpb_stock_proto_rawDesc = "" +
	...
	"\aItemIDs\x18\x01 \x03(\tR\aItemIDs\"6\n" +
	...
	"\x05items\x18\x02 \x03(\v2\r.orderpb.ItemR\x05items2\xb0\x01\n" +
	"\fstockService\x12>\n" +
	"\bGetItems\x12\x18.stockpb.GetItemsRequest\x1a\x18.stockpb.GetItemResponse\x12`\n" +
	"\x13CheckIfItemsInStock\x12#.stockpb.CheckIfItemsInStockRequest\x1a$.stockpb.CheckIfItemsInStockResponseB7Z5github.com/xh/gorder/internal/common/genproto/stockpbb\x06proto3"
